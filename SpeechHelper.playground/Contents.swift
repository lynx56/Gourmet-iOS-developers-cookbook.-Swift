...
class SpeachHelper: NSObject, AVSpeechSynthesizerDelegate{
    ...
    func speakString(_ string: String, languageCode: String, withCompletion completion: @escaping ()->Void) throws{
        if Locale.availableIdentifiers.first(where: {$0 == languageCode}) != nil{
...
let helper = SpeachHelper()
try! helper.speakString("Бедных людей удовлетворить труднее всего. Дайте им что-то бесплатно, они решат, что это ловушка. Скажите им, что это лишь небольшая инвестиция, скажут - много не заработать. Скажите им вложиться по крупному, скажут что у них нет денег. Скажите им попробовать новые темы, скажут - нет опыта. Скажите им,что это традиционный бизнес, скажут что это тяжело. Скажите им, что это новая бизнес-модель, они скажут - пирамида . Скажите им, открыть магазин, скажут - нет свободы. Скажите им начать новый бизнес,скажут что нет доказательств что новый бизнес пойдет. Они имеют нечто общее: Любят запрашивать Google, слушаться друзей, таких же безнадежных, как и они сами, они пребывают в раздумьях больше, чем профессор университета и делают меньше чем слепой. Просто спросите их, что они могут? Они не ответят вам. Мой вывод: Вместо того, чтобы ваше сердце билось быстрее, почему бы просто не действовать немного быстрее; вместо того, чтобы просто пребывать в раздумьях, почему бы не сделать то, о чем вы думаете. Бедные люди терпят неудачи из-за одной общей черты: Их Вся Жизнь Проходит в Ожидании.", languageCode: "ru"){
